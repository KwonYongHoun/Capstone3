...
final Map<String, List<ExerciseEquipment>> exerciseEquipment = {
  '가슴': [
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/flat_bench.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/incline.jpg',
      url:
    ...
    ExerciseEquipment(
      ...
      description:
          ...
          '3. 가슴 근육의 수축을 느끼며 바닥의 수직방향으로 바벨을 밀어올립니다.\n\n',
      imageUrl: 'assets/images/decline.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/assist dips.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/chest press.png',
      url:
    ...
    ExerciseEquipment(
        ...
        imageUrl: 'assets/images/Hpushup.png',
        url:
    ...
    ExerciseEquipment(
        ...
        imageUrl: 'assets/images/Cpushup.jpg',
        url:
    ...
    ExerciseEquipment(
        ...
        imageUrl: 'assets/images/squeeze.png',
        url:
  ...
  '어깨': [
    ExerciseEquipment(
      ...
      description: '1. 가슴을 활짝 편 상태로, 의자에 윗 등을 붙이고 앉습니다.\n\n'
          ...
          '3. 가슴 근육의 이완을 느끼면서 팔꿈치를 뒤로 천천히 이동합니다. (이때, 손목과 팔꿈치가 일직선이 되도록 합니다.).\n\n',
      imageUrl: 'assets/images/체스트프레스.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/숄더 프레스.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/오버헤드.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/덤벨 숄더.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/프론트 덤벨.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/레터럴.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/핸드 스탠드.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/숄더탭.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/Y레이즈.png',
      url:
  ...
  '하체': [
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/레그 익스텐션.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/레그컬.jpg',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/레그 프레스.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/힙 어브덕션.jpg',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/쓰러스트.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/글루트.png',
      url:
  ...
  '팔': [
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/덤벨 컬.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/바벨 컬.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/이지바.jpg',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/벤치딥스.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/덤벨리스트.png',
      url:
    ...
    ExerciseEquipment(
      ...
      description: '1. 벤치에 양손을 올린 뒤, 이지바를 언더 그립(손바닥을 위로 향하게 잡는 방법)으로 잡습니다.\n\n'
          '2. 손목을 아래쪽으로 젖혀주면서 손가락을 살짝 풀어줍니다.\n\n'
          '3. 손가락과 손목을 최대한 높이 말아올리면서 전완근을 수축시켜줍니다.\n\n',
      imageUrl: 'assets/images/이지바리스트.png',
      url:
    ...
    ExerciseEquipment(
      ...
      description: '1. 벤치에 양손을 올린 뒤, 바벨를 언더 그립(손바닥을 위로 향하게 잡는 방법)으로 잡습니다.\n\n'
          '2. 손목을 아래쪽으로 젖혀주면서 손가락을 살짝 풀어줍니다.\n\n'
          '3. 손가락과 손목을 최대한 높이 말아올리면서 전완근을 수축시켜줍니다.\n\n',
      imageUrl: 'assets/images/바벨리스트.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/덤벨킥백.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/트라이셉.png',
      url:
  ...
  '등': [
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/랫풀다운.png',
      url:
          'https://www.youtube.com/results?search_query=%EB%9E%AB%ED%92%80%EB%8B%A4%EC%9A%B4',
    ),
    ExerciseEquipment(
      name: '시티드 케이블 로우',
      description: '1. 케이블을 마주보고 앉아 발판에 발을 올린후 무릎을 살짝 굽혀줍니다.\n\n'
          '2. 허리를 펴고 가슴을 내민 상태에서 케이블을 잡아 당깁니다. 이때 등 중앙부를 접는다는 느낌으로 팔꿈치를 척추쪽으로 모아줍니다.\n\n'
          '3. 중량을 등으로 버티면서 천천히 팔을 펴서 시작 자세로 돌아갑니다.\n\n',
      imageUrl: 'assets/images/시티드.png',
      url:
    ...
    ExerciseEquipment(
      ...
      description: '1. 다리를 골반너비로 벌리고, 상체를 숙여 손등이 위로 향하게끔 덤벨을 잡습니다.\n\n'
          ...
          '3. 팔꿈치를 몸쪽으로 붙인다는 생각으로 팔을 굽혀 덤벨을 복부까지 끌어당겨 줍니다.\n\n'
          '4. 등의 자극을 느끼며 덤벨을 내려 2번의 자세로 돌아갑니다.\n\n',
      imageUrl: 'assets/images/라잉로우.png',
      url:
          'https://www.youtube.com/results?search_query=%EB%8D%A4%EB%B2%A8+%EB%A1%9C%EC%9A%B0',
    ),
    ExerciseEquipment(
      ...
      description: '1. 다리를 골반너비로 벌리고, 상체를 숙여 손등이 위로 향하게끔 덤벨을 잡습니다.\n\n'
          ...
          '3. 팔꿈치를 몸쪽으로 붙인다는 생각으로 팔을 굽혀 덤벨을 복부까지 끌어당겨 줍니다.\n\n'
          '4. 등의 자극을 느끼며 덤벨을 내려 2번의 자세로 돌아갑니다.\n\n',
      imageUrl: 'assets/images/언더그립.png',
      url:
          'https://www.youtube.com/results?search_query=%EB%8D%A4%EB%B2%A8+%EB%A1%9C%EC%9A%B0',
    ),
    ExerciseEquipment(
    ...
    ExerciseEquipment(
      ...
      description: '1. 다리를 골반너비로 벌리고, 상체를 숙여 손등이 위로 향하게끔 덤벨을 잡습니다.\n\n'
          ...
          '3. 팔꿈치를 몸쪽으로 붙인다는 생각으로 팔을 굽혀 덤벨을 복부까지 끌어당겨 줍니다.\n\n'
          '4. 등의 자극을 느끼며 덤벨을 내려 2번의 자세로 돌아갑니다.\n\n',
      imageUrl: 'assets/images/풀오버.png',
      url:
          'https://www.youtube.com/results?search_query=%EB%8D%A4%EB%B2%A8+%EB%A1%9C%EC%9A%B0',
    ),
    ExerciseEquipment(
      ...
      description: '1. 다리를 골반너비로 벌리고, 상체를 숙여 손등이 위로 향하게끔 덤벨을 잡습니다.\n\n'
          ...
          '3. 팔꿈치를 몸쪽으로 붙인다는 생각으로 팔을 굽혀 덤벨을 복부까지 끌어당겨 줍니다.\n\n'
          '4. 등의 자극을 느끼며 덤벨을 내려 2번의 자세로 돌아갑니다.\n\n',
      imageUrl: 'assets/images/백 익스텐션.png',
      url:
          'https://www.youtube.com/results?search_query=%EB%8D%A4%EB%B2%A8+%EB%A1%9C%EC%9A%B0',
    ),
  ],
  '복근': [
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/복근 크런치.jpg',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/디클라인 크런치.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/러시안 트위스트.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/브이업.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/크런치.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/레그레이즈.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/플랭크.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/사이드 플랭크.png',
      url:
  ...
  '유산소': [
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/사이클.jpg',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/스텝밀.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/하이니.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/트레드밀.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/이단 뛰기.png',
      url:
    ...
    ExerciseEquipment(
      ...
      description: '1. 몸에 힘을 빼고 시선은 정면을 향한 상태로 곧게 섭니다.\n\n'
          ...
          '3. 무릎의 탄력을 이용하여 수직으로 점프하여 줄을 넘습니다.\n\n',
      imageUrl: 'assets/images/줄넘기.png',
      url:
  ...
  '기타': [
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/점핑 잭.jpg',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/마운틴.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/쓰러스터.jpeg',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/인치웜.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/케틀벨.png',
      url:
    ...
    ExerciseEquipment(
      name: '터키쉬 겟업',
      description: '1. 이 운동은 복잡한 동작으로, 적절한 지도가 가능한 트레이너와 상담하는 것을 추천합니다.\n\n'
          '2. 바닥에 곧게 누운 상태에서 케틀벨을 잡은 손을 바닥과 수직방향으로 곧게 뻗습니다. 이때, 같은쪽의 무릎은 90도로 굽혀 발바닥으로 바닥을 지지합니다.\n\n'
          '3. 케틀벨을 지속적으로 밀어올리면서 반대쪽 손과 다리를 활용하여 몸을 천천히 일으킵니다.\n\n'
          '4. 케틀벨 바닥면과 수직하게 유지하면서 곧게 일어섭니다.\n\n'
          '5. 일어설때의 역순서로 동작을 취하면서 시작 자세로 돌아갑니다.\n\n',
      imageUrl: 'assets/images/터키쉬.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/파머스.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/덤벨 버피.png',
      url:
    ...
    ExerciseEquipment(
      ...
      imageUrl: 'assets/images/덤벨 쓰러스터.png',
      url:
